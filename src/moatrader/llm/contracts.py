...
class LLMTask(StrEnum):
    HISTORICAL_PREPROCESSING = "HISTORICAL_PREPROCESSING"
    HISTORICAL_EVIDENCE_CLASSIFICATION = "HISTORICAL_EVIDENCE_CLASSIFICATION"
    HISTORICAL_ENTAILMENT_CHECK = "HISTORICAL_ENTAILMENT_CHECK"
